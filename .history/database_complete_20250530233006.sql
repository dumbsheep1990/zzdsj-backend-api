...
('perm-agent-definition-read', '智能体定义查看', 'agent_definition:read', '查看智能体定义', 'agent_definition'),
('perm-agent-definition-write', '智能体定义编辑', 'agent_definition:write', '编辑智能体定义', 'agent_definition'),
('perm-tool-read', '工具查看', 'tool:read', '查看工具定义', 'tool'),
('perm-tool-write', '工具编辑', 'tool:write', '编辑工具定义', 'tool'),
('perm-question-read', '问题查看', 'question:read', '查看问题', 'question'),
('perm-question-write', '问题编辑', 'question:write', '编辑问题', 'question')
ON CONFLICT (id) DO NOTHING;
...
('role-admin', 'perm-agent-definition-read'),
('role-admin', 'perm-agent-definition-write'),
('role-admin', 'perm-tool-read'),
('role-admin', 'perm-tool-write'),
('role-admin', 'perm-question-read'),
('role-admin', 'perm-question-write')
...
('role-developer', 'perm-agent-definition-read'),
('role-developer', 'perm-agent-definition-write'),
('role-developer', 'perm-tool-read'),
('role-developer', 'perm-tool-write'),
('role-developer', 'perm-question-read'),
('role-developer', 'perm-question-write')
ON CONFLICT (role_id, permission_id) DO NOTHING;
...
('role-user', 'perm-agent-definition-read'),
('role-user', 'perm-agent-definition-write'),
('role-user', 'perm-tool-read'),
('role-user', 'perm-tool-write'),
('role-user', 'perm-question-read'),
('role-user', 'perm-question-write')
ON CONFLICT (role_id, permission_id) DO NOTHING;
