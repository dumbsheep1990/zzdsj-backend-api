...
- [ ] `knowledge/retrieval_service.py` - 待重构
- [ ] `knowledge/legacy_service.py` - 待重构
...
#### knowledge 模块剩余服务
- `knowledge/retrieval_service.py` - 需要使用 `core.knowledge.RetrievalManager`
- `knowledge/legacy_service.py` - 需要评估是否保留或重构
