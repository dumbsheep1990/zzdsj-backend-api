...
from app.utils.core.database import check_database_health
...
class ServiceHealthChecker:
    ...
    async def check_database(cls) -> Dict[str, Any]:
        ...
        try:
            ...
            status = health_result.get("healthy", False)
            error_msg = health_result.get("error") if not status else None
        except Exception as e:
            status = False
