"""
OWL框架API主模块: 提供任务处理、工作流创建和执行的API接口
[迁移桥接] - 该文件已迁移至 app/api/frontend/frameworks/owl/main.py
"""
...
# 导入新的API模块
from app.api.frontend.frameworks.owl.main import router as new_router
...
# 记录迁移警告
logger.warning("使用已弃用的app/api/owl.py，该文件已迁移至app/api/frontend/frameworks/owl/main.py")
